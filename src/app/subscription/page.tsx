  ...
  return (
    <div style={{ minHeight: "100dvh", background: "rgb(6,4,2)", position: "relative", overflowX: "clip" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, padding: "100px clamp(24px,6vw,80px) 120px", maxWidth: 720, margin: "0 auto" }}>
        ...
        <p style={{ fontFamily: "var(--font-body)", fontSize: 16, fontWeight: 200, color: "rgba(240,223,200,0.55)", lineHeight: 1.7 }}>
          Subscription plans are coming soon. In the meantime, head to the{" "}
          <Link href="/shop" style={{ color: "rgba(200,144,58,0.85)", textDecoration: "none", borderBottom: "1px solid rgba(200,144,58,0.5)" }}>shop</Link>{" "}
          to set up recurring deliveries manually.
        </p>
      </div>
    </div>
  );
