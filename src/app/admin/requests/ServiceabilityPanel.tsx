...
// Serviceability Requests panel — customer-submitted "deliver here please"
// requests from unserviceable pincodes. Two actions per row:
//   - Mark Serviceable: activates the pincode + WhatsApps the customer.
//   - Reject: silently dismisses (admin can follow up manually).
//
// Extracted verbatim from the old /admin/delivery-requests page so it can be
// rendered under a tab on the combined /admin/requests page. Logic, polling,
// and API calls are unchanged — only the AdminShell wrapper was removed (the
